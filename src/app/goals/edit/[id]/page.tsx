    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 p-6">
        <div className="w-full max-w-md bg-white p-8 rounded-md shadow-md dark:bg-gray-800">
          <h2 className="mb-4 text-2xl font-semibold text-center text-black dark:text-white">Editar Meta</h2>
          ...
          <Button onClick={handleUpdate} className="w-full p-2 font-semibold text-white bg-blue-500 hover:bg-blue-600">
            Atualizar Meta
          </Button>
        </div>
      </div>
