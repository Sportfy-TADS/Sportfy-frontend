...
import { createGoal } from '../http/create-goal'; // Função para criar metas
...
export function CreateGoal() {
  ...
  async function handleCreateGoal(data: CreateGoalSchema) {
    const { title, desiredWeeklyFrequency } = data; // Destructure the properties
        ...
        <form onSubmit={handleSubmit(handleCreateGoal)} className="flex-1 flex flex-col justify-between">
          <div className="space-y-6">
            <div className="flex flex-col gap-2">
              ...
              <Input id="title" placeholder="Praticar exercícios, meditar, etc..." {...register('title')} />
